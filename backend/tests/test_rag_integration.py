...
class TestRAGIntegration:
    ...
    def test_system_initialization(self):
        ...
        tool_names = [
            ...
            for tool in self.rag_system.tool_manager.tools.values()
        ]
    ...
    def test_outline_query_integration(self):
        ...
        response, sources = self.rag_system.query(
            f"What lessons are in the {course_name} course?"
        )
    ...
    def test_vector_store_content(self):
        ...
        if course_count > 0:
            ...
            if not search_results.is_empty():
                print(
                    f"  - First document preview: {search_results.documents[0][:100]}..."
                )
