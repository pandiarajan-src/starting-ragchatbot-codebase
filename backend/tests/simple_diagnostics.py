...
def test_search_tool():
    ...
    try:
        ...
        if "error" in result.lower() and "no relevant content found" not in result.lower():
...
def test_ai_generator():
    ...
    try:
        ...
        # Check API key
        has_api_key = bool(config.ANTHROPIC_API_KEY and config.ANTHROPIC_API_KEY != "your_anthropic_api_key_here")
...
def test_rag_system():
    ...
    try:
        ...
        search_result = rag_system.tool_manager.execute_tool("search_course_content", query="test")
